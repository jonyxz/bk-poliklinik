                            ...
                            @foreach ($janjiPeriksas as $janjiPeriksa)
                                <tr>
                                    ...
                                    <td class="align-middle text-start">
                                        {{ $janjiPeriksa->jadwalPeriksa->dokter->polis->nama ?? 'NA' }}</td>
                                    <td class="align-middle text-start">
                                    ...
                                    <td class="align-middle text-start">
                                        @if (is_null($janjiPeriksa->periksa))
                                            <a href="{{route('pasien.riwayat_periksa.detail', $janjiPeriksa->id)}}" class="btn btn-info">Detail</a>
                                                        ...
                                                        <div class="modal-body">
                                                            <ul class="list-group">
                                                                <li class="list-group-item">
                                                                    ...
                                                                    {{ $janjiPeriksa->jadwalPeriksa->dokter->polis->nama ?? 'NA' }}
                                                                </li>
                                                                <li class="list-group-item">
                                        ...
                                        @else
                                            <a href="{{route('pasien.riwayat_periksa.riwayat', $janjiPeriksa->id)}}" class="btn btn-secondary">Riwayat</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
